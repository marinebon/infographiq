...
-   **tooltip**: whether a tooltip should appear when the mouse hovers over a clickable element in the infographic (see image below for example of a tooltip). Allowable values are true and false (note: no quotation marks). The default value is true.
